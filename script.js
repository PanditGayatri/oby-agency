...
document.querySelector("#hero2,#hero3,#hero4",).addEventListener("mouseenter",function(){
  gsap.to("#flag",{
    opacity:1
})
})
document.querySelector("#hero2,#hero3,#hero4",).addEventListener("mouseleave",function(){
  gsap.to("#flag",{
    opacity:0
})
})
